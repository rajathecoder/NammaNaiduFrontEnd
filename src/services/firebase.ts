...
if (!firebaseConfig.apiKey) {
  ...
  // Throwing an error to prevent app from running with insecure default credentials or missing config.
  throw new Error('Critical configuration missing. Please check your environment variables.');
}
