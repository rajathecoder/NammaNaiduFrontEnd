...
const ensureFirebaseApp = () => {
  if (!getApps().length) {
    // Security enhancement: Validate critical configuration
    if (!firebaseConfig.apiKey || !firebaseConfig.projectId || !firebaseConfig.appId) {
      throw new Error('Firebase configuration is incomplete or missing. Please check your environment variables.');
    }
