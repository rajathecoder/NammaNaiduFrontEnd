                        ...
                        {planType === 'months' && monthlyPlans.length > 0 && (
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                                {monthlyPlans.map((plan) => (
                                    <div
                                        key={plan.id}
                                        className="bg-white border-2 border-gray-200 rounded-2xl p-8 text-center transition-all duration-200 hover:border-[#1B5E20] hover:shadow-[0_6px_16px_rgba(27,94,32,0.15)]"
                                    >
                                        ...
                                        <button
                                            className="w-full bg-gradient-to-r from-[#1B5E20] to-[#0D3B13] text-white font-semibold py-3 px-6 rounded-full transition-all duration-200 hover:shadow-[0_6px_16px_rgba(27,94,32,0.3)] hover:-translate-y-0.5"
