            ...
            <div className="min-h-screen bg-gray-100">
                ...
                <div className="flex items-center justify-center min-h-[60vh]">
                    <div className="text-center">
                        ...
                        <button onClick={() => navigate('/home')} className="py-2.5 px-5 bg-[#1B5E20] text-white rounded-lg font-semibold cursor-pointer transition-colors duration-200 hover:bg-[#0D3B13]">
                            Go Back to Home
                        </button>
                    </div>
                </div>
        ...
        <div className="min-h-screen bg-[#f8f9fa]">
            ...
            <div className="max-w-7xl mx-auto py-8 px-6">
                ...
                <div className="flex justify-between items-center mb-10 bg-white p-6 rounded-[32px] shadow-sm border border-gray-100/50">
                    <button
                        className="h-12 px-8 bg-gray-50 text-gray-700 rounded-full font-bold text-sm flex items-center gap-2 transition-all hover:bg-white hover:shadow-md hover:text-[#0D3B13]"
                    ...
                    <div className="flex gap-4 items-center">
                        ...
                        <button
                            className="w-12 h-12 bg-white border border-gray-100 rounded-2xl flex items-center justify-center text-gray-600 font-bold transition-all hover:shadow-lg hover:border-[#0D3B1340] hover:text-[#0D3B13] disabled:opacity-30"
                    ...
                    <div className="col-span-8 lg:col-span-12">
                        <div className="bg-white rounded-[40px] shadow-xl shadow-gray-200/50 border border-gray-100 overflow-hidden mb-8">
                            ...
                            <div className="p-6 border-b border-gray-50 bg-gradient-to-b from-gray-50/50 to-white">
                                <div className="flex gap-6 items-start md:flex-col">
                                    <div className="relative shrink-0">
                                        <div
                                            className={`w-[160px] h-[160px] rounded-[32px] bg-gradient-to-br from-[#1B5E20] to-[#0D3B13] flex items-center justify-center text-white text-5xl font-black overflow-hidden shadow-xl shadow-[#1B5E2020] relative ${getAllPhotos().length > 0 ? 'cursor-pointer group' : ''}`}
                                    ...
                                    <div className="flex-1 pt-2">
                                        ...
                                        <p className="text-[#0D3B13] font-bold text-sm mb-4 flex items-center gap-1">
                                        ...
                                        <div className="flex items-center gap-2 text-gray-600 font-bold text-xs bg-gray-50/50 p-3 rounded-xl border border-gray-100/50">
                                            ...
                                            <span>{height}</span>
                                            <span className="opacity-20 text-gray-300">|</span>
                                            <span className="text-[#0D3B13]">{caste}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            {!isOwnProfile && !hasViewedDetails && (
                                <div className="p-4 bg-gradient-to-r from-[#1B5E2010] to-[#0D3B1310] border-b border-gray-100/50">
                                    <button
                                        className="w-full h-12 bg-gradient-to-r from-[#1B5E20] to-[#0D3B13] text-white rounded-xl font-black text-xs uppercase tracking-widest transition-all duration-300 shadow-lg hover:shadow-xl hover:-translate-y-0.5 disabled:opacity-50 flex items-center justify-center gap-2"
                        ...
                        <div className="px-6 border-b border-gray-100 bg-white sticky top-0 z-20 overflow-x-auto scrollbar-hide">
                            <div className="flex gap-8 min-w-max">
                                {[
                                    ...
                                    <button
                                        key={tab.id}
                                        className={`py-4 text-xs font-black uppercase tracking-widest transition-all relative ${activeTab === tab.id ? 'text-[#1B5E20]' : 'text-gray-400 hover:text-gray-600'}`}
                                        onClick={() => setActiveTab(tab.id as any)}
                                    >
                                        {tab.label}
                                        {activeTab === tab.id && <div className="absolute bottom-0 left-0 right-0 h-0.5 bg-gradient-to-r from-[#1B5E20] to-[#0D3B13] rounded-t-full"></div>}
                                    </button>
                                ))}
                            </div>
                        </div>
                        ...
                        <div className="bg-white rounded-[40px] p-8 shadow-xl shadow-gray-200/50 border border-gray-100">
                            ...
                            <div className="space-y-6">
                                {similarMatches.slice(0, 3).map((match: any) => (
                                    ...
                                    >
                                        <div className="w-16 h-16 rounded-2xl bg-[#1B5E2010] flex items-center justify-center text-2xl shrink-0 group-hover:scale-110 transition-transform">{match.name?.charAt(0) || '👤'}</div>
                                        <div className="flex-1 min-w-0">
                                            <div className="font-black text-[#1a1a1a] truncate group-hover:text-[#1B5E20] transition-colors">{match.name}</div>
                                            <div className="text-xs text-gray-400 font-bold">{match.age || '?'} Yrs • {match.basicDetail?.city || 'Not Specified'}</div>
                                        </div>
                                        <div className="text-gray-300 group-hover:text-[#1B5E20] transition-colors">›</div>
                                    </div>
                                ))}
                            </div>
                            <button className="w-full mt-8 py-4 text-xs font-black uppercase tracking-widest text-gray-400 hover:text-[#0D3B13] transition-colors border-t border-gray-50 pt-6" onClick={() => navigate('/home')}>View All Recommendations</button>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div className="relative max-w-4xl w-full h-[80vh] flex items-center justify-center">
                        ...
                        <div className="absolute bottom-4 flex gap-3">
                            {getAllPhotos().map((_, idx) => (
                                <div key={idx} className={`w-2 h-2 rounded-full transition-all ${idx === selectedImageIndex ? 'w-8 bg-[#1B5E20]' : 'bg-white/20'}`}></div>
                            ))}
                        </div>
                    </div>
                </div>
                ...
                <div className="fixed inset-0 z-[100] bg-black/50 flex items-center justify-center p-4 animate-in fade-in duration-300">
                    <div className="bg-white rounded-2xl p-6 max-w-md w-full shadow-2xl">
                        ...
                        <div className="flex gap-3">
                            ...
                            <button
                                className="flex-1 h-11 bg-gradient-to-r from-[#1B5E20] to-[#0D3B13] text-white rounded-xl font-black text-xs uppercase tracking-widest transition-all hover:shadow-lg"
...
const DetailRow = ({ label, value, isFullWidth = false }: { label: string; value: any; isFullWidth?: boolean }) => {
    ...
    return (
        <div className={`${isFullWidth ? 'col-span-2' : ''} group`}>
            <span className="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1.5 block group-hover:text-[#1B5E20] transition-colors">{label}</span>
