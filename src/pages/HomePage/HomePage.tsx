        ...
        const fetchOppositeGenderProfiles = async () => {
            ...
            try {
                ...
                if (response.success && response.data) {
                    ...
                    // ⚡ Bolt: Eliminate N+1 API calls for profile photos. The backend includes personphoto in the opposite gender profiles response, so we extract the primary photo directly instead of fetching it per user.
