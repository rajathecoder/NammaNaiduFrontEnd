        ...
        const fetchOppositeGenderProfiles = async () => {
            ...
            try {
                ...
                if (response.success && response.data) {
                    ...
                    // ⚡ Bolt: Prevent N+1 API calls by mapping photos directly from the nested relation included in the initial payload
                    const photosMap: Record<string, { photo1link?: string }> = {};
                    response.data.forEach((profile: UserProfile & { personPhoto?: { photo1?: string } }) => {
                        if (profile.personPhoto?.photo1 && profile.personPhoto.photo1 !== 'null') {
