        ...
        const fetchOppositeGenderProfiles = async () => {
            ...
            try {
                ...
                if (response.success && response.data) {
                    ...
                    // ⚡ Bolt: Removed N+1 API calls for profile photos. The getOppositeGenderProfiles API payload already includes the user's photo information nested in a lowercase personphoto array, making the separate /api/users/photos fetch redundant.
                    const photosMap: Record<string, { photo1link?: string }> = {};
                    type ProfileWithPhotos = UserProfile & { personphoto?: Array<{ photoplacement: number, photo1link?: string }> };
                    response.data.forEach((profile: ProfileWithPhotos) => {
