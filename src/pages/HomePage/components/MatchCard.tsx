...
interface MatchCardProps {
    ...
    onPrimaryAction?: (e: React.MouseEvent, profile?: any) => void;
    onFavorite?: (e: React.MouseEvent, profile?: any) => void;
    isFavorite?: boolean;
}
            ...
            <div className="absolute inset-x-0 bottom-0 p-5 z-10">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <button
                        ...
                        onClick={(e) => {
                            e.stopPropagation();
                            if (onFavorite) onFavorite(e, profile);
                        }}
                    >
