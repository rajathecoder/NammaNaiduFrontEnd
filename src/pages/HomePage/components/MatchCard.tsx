        ...
        >
            ...
            <div className="absolute inset-0 bg-gray-200">
                {profilePhoto ? (
                    <img
                        ...
                        onError={(e) => {
                            ...
                            if (parent && !parent.querySelector('.fallback-initial')) {
                                ...
                                fallback.className = 'fallback-initial w-full h-full flex items-center justify-center text-6xl text-white font-bold bg-gradient-to-br from-[#FB34AA] to-[#C204E7]';
                    ...
                    <div className="w-full h-full flex items-center justify-center text-6xl text-white font-bold bg-gradient-to-br from-[#FB34AA] to-[#C204E7]">
            ...
            <div className="absolute inset-x-0 bottom-0 p-5 z-10">
                ...
                <div className="flex items-center gap-2">
                    <button
                        className="h-9 px-4 flex-1 bg-white text-[#C204E7] rounded-xl font-bold text-sm flex items-center justify-center gap-2 transition-all duration-300 hover:bg-[#C204E7] hover:text-white hover:scale-[1.05] active:scale-95 border-none cursor-pointer shadow-lg whitespace-nowrap"
                        onClick={(e) => {
                            e.stopPropagation();
                            if (onPrimaryAction) {
                                onPrimaryAction(e);
                    ...
                    <button
                        className={`w-9 h-9 backdrop-blur-md border rounded-xl flex items-center justify-center transition-all duration-300 hover:scale-[1.05] active:scale-95 cursor-pointer shadow-lg ${isFavorite ? 'bg-[#FB34AA] border-[#FB34AA] text-white' : 'bg-white/20 border-white/30 text-white hover:bg-white/40'}`}
                        onClick={(e) => {
                            e.stopPropagation();
