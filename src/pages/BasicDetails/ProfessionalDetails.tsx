                    ...
                    <form onSubmit={handleNext} className="w-full">
                        ...
                        <div className="grid grid-cols-2 gap-4 mb-7">
                            <div className="relative">
                                <label className="block text-sm font-medium text-gray-800 mb-2">State <span className="text-[#ff6b35] font-semibold">*</span></label>
                                {district ? (
                                    <input
                                        type="text"
                                        value={state}
                            ...
                            <div className="relative">
                                <label className="block text-sm font-medium text-gray-800 mb-2">Country <span className="text-[#ff6b35] font-semibold">*</span></label>
                                {district ? (
                                    <input
                                        type="text"
                                        value={country}
                        ...
                        {postOffices.length > 0 && (
                            <div className="relative mb-7">
                                <label className="block text-sm font-medium text-gray-800 mb-2">City <span className="text-[#ff6b35] font-semibold">*</span></label>
                                <select
                                    value={city}
