...
const Matches = () => {
    ...
    // ⚡ Bolt Performance Optimization: Memoize array filtering to prevent O(N) recalculations on unrelated state changes
    ...
    // ⚡ Bolt Performance Optimization: Memoize pagination slicing to prevent recalculations
