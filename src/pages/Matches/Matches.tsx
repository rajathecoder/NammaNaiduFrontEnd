...
const Matches = () => {
    ...
    // Memoize filtering logic to prevent O(N) recalculations on re-renders
    const filteredProfiles = useMemo(() => {
        if (selectedFilter === 'newly-joined') {
            // Extract static date outside filter loop to prevent redundant instantiations
    ...
    // Memoize pagination calculation and slicing separate from filtering
