...
const Matches = () => {
    ...
    // ⚡ Bolt Optimization: Memoize filtered profiles calculation
    // Impact: Prevents O(N) array filtering on every component re-render (e.g. during pagination or state updates).
    // The filter operation will now only run when allMatches data or the selected filter type changes.
