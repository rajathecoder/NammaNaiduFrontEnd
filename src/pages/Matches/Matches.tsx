...
const Matches = () => {
    ...
    useEffect(() => {
        const fetchMatches = async () => {
            try {
                ...
                const profilesPromise = getOppositeGenderProfiles(authData.token).catch(err => {
                ...
                const [response, dl, interestsData] = await Promise.all([profilesPromise, shortlistPromise, interestPromise]);
    ...
    // Calculate pagination with filtering, memoized to prevent redundant calculations
