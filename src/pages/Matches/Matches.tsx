...
const Matches = () => {
    ...
    // ⚡ Bolt Optimization: Memoize the filtered array to prevent O(N) recalculations on every render.
    // This reduces CPU overhead during component updates, particularly with large datasets.
    ...
    // ⚡ Bolt Optimization: Memoize pagination calculations to prevent re-slicing the array
    // and re-calculating page counts unless the current page, items per page, or filtered list changes.
