...
const Matches = () => {
    ...
    // ⚡ Bolt Performance Optimization: Wrapped getFilteredProfiles in useMemo to prevent O(N) filtering recalculations when pagination changes
    ...
    // ⚡ Bolt Performance Optimization: Wrapped slice in useMemo to prevent recalculating slice unless needed
