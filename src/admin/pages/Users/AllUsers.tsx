...
const AllUsers: React.FC = () => {
  ...
  // ⚡ Bolt: Optimize filtering logic to prevent O(N) recalculations on every render.
  // ⚡ Hoists .toLowerCase() transformation outside the loop to avoid redundant string allocations.
  ...
  // ⚡ Bolt: Memoize array slicing to prevent redundant re-renders of the child list unless the page or filtered data changes.
